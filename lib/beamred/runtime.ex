defmodule BeamRED.Runtime do
  ...
  defp default_workspace() do
    node_types = %{
      BeamRED.Nodes.BeamModule => BeamRED.Nodes.BeamModule.__node_definition__(),
      BeamRED.Nodes.BeamProcess => BeamRED.Nodes.BeamProcess.__node_definition__(),
      BeamRED.Nodes.BeamSend => BeamRED.Nodes.BeamSend.__node_definition__()
    }
